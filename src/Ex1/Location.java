...
public class Location 
{
	...
	public int setLat(double lat) {			//return 0-if latitude is correct, 0-if latitude is incorrect
		if (lat<-90 || lat>90)
			return 0;
		this.lat = lat;
		return 1;
	...
	public int setLon(double lon) {			//return 0-if longitude is correct, 0-if longitude is incorrect
		if (lon<-180 || lon>180)
			return 0;
		this.lon = lon;
		return 1;
