...
public class WIFI 
{
	 ...
	 * @return 1-if mAC is correct, 0-if mAC is incorrect
	 */
	...
	public int setFrequency(int frequency) {			//return 1-if frequency is correct, and 0-if frequency is incorrect
		if (frequency>0)
		{
