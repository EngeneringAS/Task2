...
class HelpFunctionsTest {
	...
	final void testweight_pi() 
	{
		...
		assertEquals(0.4769885454073238,hf.weight_pi(input, output));
		...
		assertEquals(0.17381326045114823,hf.weight_pi(input, output));
		//third initialization of output
		output.removeAll(output);
		Otmp1.setSignal(-120);	output.add(Otmp1);
		Otmp2.setSignal(-120);	output.add(Otmp2);
		Otmp3.setSignal(-120);	output.add(Otmp3);
		assertEquals(0.0401216599197276,hf.weight_pi(input, output));
		assertEquals(-1,hf.weight_pi(input, null));
		assertEquals(-1,hf.weight_pi(null, output));
	}
